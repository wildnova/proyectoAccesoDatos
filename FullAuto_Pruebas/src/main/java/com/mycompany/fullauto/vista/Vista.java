...
public class Vista extends javax.swing.JFrame implements ActionListener{
    ...
    public void insertarVehiculo()
    {
        ...
        if(confirmarInsertar)
        {
            Vehiculo vehiculo=new Vehiculo(fv.getBastidor(),fv.getMatricula(),fv.getMarca(),fv.getModelo(),fv.getMotor(),fv.getPotencia(),fv.getCarburante(),fv.getAceite(),fv.getConsumo(),fv.getFechaEntrada(),fv.getTiempoDedicado());
    ...
    public void modificarVehiculo()
    {
         boolean confirmarModificar;
        //Esta variable se usa para guardar el dni que corresponde al trabajador que se va a modificar cuando se haga la búsqueda en la base de datos en el modelo.
        String bastidorOriginal;
        
        Vehiculo vehiculo = listaVehiculos.get(contadorVehiculo);
        bastidorOriginal= vehiculo.getBastidor();
        FormularioVehiculo fv = new FormularioVehiculo(this, true);
        ...
        if(confirmarModificar)
        {
            ...
            controlador.modificarVehiculo(vehiculo,bastidorOriginal);
    ...
    public void cargarCamposVehiculo(Vehiculo vehiculo)
    {
    ...
    private void initComponents() {
        ...
        fondoMainLayout.setVerticalGroup(
            ...
            .addGroup(fondoMainLayout.createSequentialGroup()
                ...
                .addComponent(jtpTablaPrincipal, javax.swing.GroupLayout.PREFERRED_SIZE, 618, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(fondoMain, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
